      ...
      <div className="hidden lg:flex relative bg-slate-900 items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 px-12 max-w-lg">
          <div className="flex items-center gap-3 mb-10">
            ...
            <div>
              <div className="text-white font-heading font-extrabold text-2xl leading-none tracking-tight">
                LAVANET
              </div>
              <div className="text-blue-300 text-xs uppercase tracking-[0.2em] mt-1">
                POS · ERP
              </div>
            </div>
          </div>
          <h1 className="text-white font-heading text-4xl xl:text-5xl font-extrabold leading-tight tracking-tight">
            ...
            <br />
            <span className="text-blue-400">simple y poderosa.</span>
          </h1>
